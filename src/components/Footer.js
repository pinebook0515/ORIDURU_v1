    ...
    <footer className="ly_footer">
      ...
      <nav className="bl_tabNav_wrapper bl_footerNav_wrapper sp_only">
        <ul className="bl_tabNav bl_footerNav fl_alignCenter">
          ...
          <FooterTabMenuItem pathName={pathName} catLink="/category/tech">
            <Link
              to="/category/tech"
          ...
          <FooterTabMenuItem pathName={pathName} catLink="/category/life">
            <Link
              to="/category/life"
              className="bl_tabNav_link bl_footerNav_link"
            >
          ...
          <FooterTabMenuItem pathName={pathName} catLink="/category/book">
            <Link
              to="/category/book"
              className="bl_tabNav_link bl_footerNav_link"
            >
          ...
          <FooterTabMenuItem pathName={pathName} catLink="/category/essay">
            <Link
              to="/category/essay"
              className="bl_tabNav_link bl_footerNav_link"
            >

...
const TabMenuItem = ({ pathName, catLink, children }) => {
  return (
    <li
      className={
        pathName === catLink ? "bl_tabNav_item js-active" : "bl_tabNav_item"
      }
    >
      {children}
    </li>
  ...
  return (
    <nav className="bl_tabNav_wrapper pc_only">
      <ul className="bl_tabNav fl_spaceBetween fl_alignCenter">
        ...
        <TabMenuItem pathName={pathName} catLink="/category/tech">
        ...
        <TabMenuItem pathName={pathName} catLink="/category/life">
          <Link to="/category/life" className="bl_tabNav_link">
            <svg
              className="bl_tabNav_icon"
              width="17"
              height="12"
            ...
            <span className="bl_tabNav_text">LIFE</span>
          </Link>
        </TabMenuItem>
        <TabMenuItem pathName={pathName} catLink="/category/book">
        ...
        <TabMenuItem pathName={pathName} catLink="/category/essay">

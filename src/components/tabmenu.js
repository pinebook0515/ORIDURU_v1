...
const TabMenuItem = ({ pathName, catLink, children }) => {
  return (
    <li
      className={
        pathName === catLink || (pathName.includes("/page/") && catLink === "/")
          ? "bl_tabNav_item js-active"
...
const TabMenu = ({ pathName }) => {
  return (
    <nav className="bl_tabNav_wrapper pc_only">
      <ul className="bl_tabNav fl_spaceBetween fl_alignCenter">
        <TabMenuItem pathName={pathName} catLink="/">
          <Link to="/" className="bl_tabNav_link">
            <svg
              className="bl_tabNav_icon"
              width="15"
              height="9"
              viewBox="0 0 15 9"
            ...
            <span className="bl_tabNav_text">NEW</span>
          </Link>
        </TabMenuItem>
        <TabMenuItem pathName={pathName} catLink="habit">
          <Link to="/category/habit/" className="bl_tabNav_link">
            <svg className="bl_tabNav_icon" width="15" height="17" viewBox="0 0 324 360" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="bl_tabNav_text">HABIT</span>
          </Link>
        </TabMenuItem>
        <TabMenuItem pathName={pathName} catLink="tech">
          <Link to="/category/tech/" className="bl_tabNav_link">
            <svg
              className="bl_tabNav_icon"
              width="17"
              height="11"
            ...
            <span className="bl_tabNav_text">TECH</span>
          </Link>
        </TabMenuItem>
        <TabMenuItem pathName={pathName} catLink="book">
          <Link to="/category/book/" className="bl_tabNav_link">
            <svg
              className="bl_tabNav_icon"
              width="12"
              height="17"
            ...
            <span className="bl_tabNav_text">BOOK</span>
          </Link>
        </TabMenuItem>
        <TabMenuItem pathName={pathName} catLink="essay">
          <Link to="/category/essay/" className="bl_tabNav_link">
            <svg
              className="bl_tabNav_icon"
              width="16"
              height="18"
            ...
            <span className="bl_tabNav_text">ESSAY</span>
          </Link>
        </TabMenuItem>
      </ul>
    </nav>

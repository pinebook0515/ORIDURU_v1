...
![行動が習慣になるプロセス](./habit_process.png)

1つずつ説明します。

### 反発期（1〜7日目）

![反発期](./repulsion_period.png)
...
![反発期の解決策](./repulsion_period_solution.png)
...
![不安定期の対策](./unstable_period_solution.png)
...
![倦怠期の対策](./bored_period_solution.png)
